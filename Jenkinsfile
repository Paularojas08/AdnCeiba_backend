pipeline {
  ...
  stages {
    stage('Checkout') {
      steps {
        ...
        credentialsId: 'GitHub_Paularojas08', url: 'https://github.com/Paularojas08/AdnCeiba_backend.git']]])
      }
    }
  ...
  post {
    ...
    failure {
      ...
      mail(to: 'paula.rojas@ceiba.com.co', subject: "Failed Pipeline:${currentBuild.fullDisplayName}", body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
